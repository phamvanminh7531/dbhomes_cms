"""
Django settings for dbhomes_cms project.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "streams.context_processors.contact_buttons",
...
WSGI_APPLICATION = "dbhomes_cms.wsgi.application"
...
CSRF_TRUSTED_ORIGINS = ["https://dbhomes.com.vn"]
APPEND_SLASH = True
...
WAGTAIL_ALLOW_DOCUMENT_UPLOAD = True
